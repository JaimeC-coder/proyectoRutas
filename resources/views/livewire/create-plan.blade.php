<div class="grid grid-cols-1 md:grid-cols-1 gap-3 lg:gap-1">
    <div class="w-full p-6 border border-default rounded-base shadow-xs dark:bg-gray-800 dark:border-gray-700">
        ...
        <form wire:submit.prevent='saveplan' class="space-y-4">
            ...
            <div class="mb-5">
                <label for="plan-description" class="block mb-3 text-sm font-medium text-heading dark:text-gray-300">
            ...
            <div class="mb-5">
                <label for="plan-observations" class="block mb-3 text-sm font-medium text-heading dark:text-gray-300">
